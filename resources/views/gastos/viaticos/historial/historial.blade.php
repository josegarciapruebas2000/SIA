...
@section('content')
    ...
    <style>
        .btn-group .btn {
            margin: 5px; /* Añadir un pequeño margen entre los botones para una mejor separación */
        }
    </style>
                    ...
                    @else
                        @foreach ($solicitudes as $solicitud)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a style="text-decoration: none;" href="{{ route('historial.solicitud', ['id'=>  $solicitud->FOLIO_via ]) }}">
