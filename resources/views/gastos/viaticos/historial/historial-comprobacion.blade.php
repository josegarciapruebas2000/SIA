...
@section('content')
    ...
    <form class="centered-form">
        ...
        @php
            ...
            $isNivel123 = in_array($user->nivel, [1, 2, 3]);
        @endphp

        <!-- Este boton solo será visible para el SuperAdmin y Usuarios con nivel 1,2 y 3 -->
        @if ($isSuperAdmin || $isNivel123)
            <a href="{{ route('generar.comprobacion', ['id' => $comprobacion->idComprobacion]) }}"
