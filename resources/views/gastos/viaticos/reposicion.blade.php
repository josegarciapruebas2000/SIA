...
@section('content')
    ...
    <form class="centered-form">
        <div class="row mb-3">
            <div class="col">
                <label for="grupo" class="form-label">Crear nueva reposición:</label>
                <input type="text" class="form-control" id="reposicion" name="reposicion" placeholder="Ingresar reposicion"
                    readonly>
            </div>
            <div class="col">
                <label for="grupo" class="form-label">Proyecto:</label>
                <input type="text" class="form-control" id="comentario" name="proyecto"
                    placeholder="Proyecto seleccionado" readonly>
            </div>
        ...
        <div class="col">
            <div class="row mb-3">
                <div class="col">
                    <label for="fecha_sesion" class="form-label">Fecha:</label>
        ...
        <div class="col">
            <div class="row mb-3">
                <div class="col">
                    <label for="fecha_sesion" class="form-label">Subir comprobante:</label>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalExito">Sí</button>
                        </div>
                    </div>
                </div>
            </div>
