        ...
        <div class="col">
            ...
            <form id="filtro-form" action="{{ route('empleados.lista') }}" method="GET" class="input-group mb-3"
                ...
                <select class="form-select text-capitalize" id="filtro-departamento" name="filtro_departamento"
                    onchange="submitForm()">
                    <option value="Todos" {{ request()->input('filtro_departamento') == 'Todos' ? 'selected' : '' }}>
                        Todos
                    </option>
                    <option value="Administrativo"
                        {{ request()->input('filtro_departamento') == 'Administrativo' ? 'selected' : '' }}>
                        Administrativo
                    </option>
                    <option value="RRHH" {{ request()->input('filtro_departamento') == 'RRHH' ? 'selected' : '' }}>
                        Rrhh
                    </option>
                    ...
                    <!-- Agrega más opciones según tus necesidades brou-->
                </select>
            </form>
        </div>
